...
class Album:
    ...
    async def from_deezer_api_album_info(
        cls, api_album_info: dict, dlna_device: Optional["DlnaDevice"] = None, deezer_client: AsyncDeezer | None = None
    ) -> "Album":
        ...
        await cls._get_tracks_instances(
            tracks_list, artist, album, dlna_device=dlna_device, deezer_client=deezer_client
        )
        return album
    ...
    async def from_deezer_by_id(cls, album_id: str, dlna_device: "DlnaDevice") -> "Album":
        ...
        album = await cls.from_deezer_api_album_info(
            album_info, dlna_device=dlna_device, deezer_client=client.async_client
        )
        return album
